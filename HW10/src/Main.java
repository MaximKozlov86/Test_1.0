...
public class Main {
    ...
    public static void main(String[] args) {
        while (true) {
            ...
            double bookPrice = inputPagePrice();
            addBook(name);
    ...
    private static int inputPagePrice() {
    ...
    public static void addBook (String bookName, int pageCount, double bookPrice){
        booksInfo = booksInfo + bookName + " - " + (pageCount > 0 ? pageCount : "N/A ") + " стр." + " цена: " + (bookPrice > 0 ? bookPrice : "N/A ") + "р." + "\n";
    }
